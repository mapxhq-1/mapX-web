...
const Open = ({ setIsOpen }) => {
  ...
  return (
    <div className="z-50 w-[300px] bg-[#2A2929] text-white " style={{height: '112vh'}}>
      ...
      <div>
        <div
          className="px-[45px] py-[15px] flex transition-all items-center duration-500 ease-in-out select-none rounded-lg cursor-pointer relative
                                bg-white/2.5 border border-white/50 backdrop-blur-sm shadow-[inset_0_1px_0px_rgba(255,255,255,0.75),0_0_9px_rgba(0,0,0,0.2),0_3px_8px_rgba(0,0,0,0.15)] hover:bg-white/30 before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-br before:from-white/40 before:via-transparent before:to-transparent before:opacity-70 before:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:bg-gradient-to-tl after:from-white/30 after:via-transparent after:to-transparent after:opacity-50 after:pointer-events-none antialiased"
      ...
      <div className="w-full h-0.5 bg-black/10"></div>
      <div>
        <p className="text-[20px] pl-[45px] my-[19px]">Shapes</p>
        <div className="grid-cols-2 grid gap-3 m-5">
          <div className="rounded-lg flex py-[5px] px-[10px] bg-white text-black items-center hover:scale-105 transition duration-200 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="none" stroke="#000" stroke-linecap="round" stroke-width="1.5" d="m21.25 2.75l-18.5 18.5"/></svg>
            <p className="text-[18px] ml-2">Line</p>
          </div>
          <div className="rounded-lg flex py-[5px] px-[10px] bg-white text-black items-center hover:scale-105 transition duration-200 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 15 15"><path fill="#000" d="M8.293 2.293a1 1 0 0 1 1.414 0l4.5 4.5a1 1 0 0 1 0 1.414l-4.5 4.5a1 1 0 0 1-1.414-1.414L11 8.5H1.5a1 1 0 0 1 0-2H11L8.293 3.707a1 1 0 0 1 0-1.414"/></svg>
            <p className="text-[18px] ml-2">Arrow</p>
          </div>
          <div className="rounded-lg flex py-[5px] px-[10px] bg-white text-black items-center hover:scale-105 transition duration-200 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="#000" d="M12 22q-2.075 0-3.9-.788t-3.175-2.137T2.788 15.9T2 12t.788-3.9t2.137-3.175T8.1 2.788T12 2t3.9.788t3.175 2.137T21.213 8.1T22 12t-.788 3.9t-2.137 3.175t-3.175 2.138T12 22m0-2q3.35 0 5.675-2.325T20 12t-2.325-5.675T12 4T6.325 6.325T4 12t2.325 5.675T12 20m0-8"/></svg>
            <p className="text-[18px] ml-2">Circle</p>
          </div>
          <div className="rounded-lg flex py-[5px] px-[10px] bg-white text-black items-center hover:scale-105 transition duration-200 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 48 48"><path fill="none" stroke="#000" stroke-width="4" d="M28.038 8H7a3 3 0 0 0-3 3v26a3 3 0 0 0 3 3h32.413c2.163 0 3.616-2.22 2.748-4.203l-11.375-26A3 3 0 0 0 28.038 8Z"/></svg>
            <p className="text-[18px] ml-2">Polygon</p>
          </div>
        </div>
      </div>
      <div>
        <div className="flex p-3 items-center justify-center gap-6 rounded-lg pointer-cursor bg-white/2.5 border border-white/50 backdrop-blur-sm shadow-[inset_0_1px_0px_rgba(255,255,255,0.75),0_0_9px_rgba(0,0,0,0.2),0_3px_8px_rgba(0,0,0,0.15)] hover:bg-white/30 transition-all duration-300 before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-br before:from-white/60 before:via-transparent before:to-transparent before:opacity-70 before:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:bg-gradient-to-tl after:from-white/30 after:via-transparent after:to-transparent after:opacity-50 after:pointer-events-none antialiased">
...
const Closed = ({ setIsOpen }) => {
  return (
    <div className=" z-50  w-[60px] flex justify-center pt-[25px] bg-white/2.5 border border-white/50 backdrop-blur-sm shadow-[inset_0_1px_0px_rgba(255,255,255,0.75),0_0_9px_rgba(0,0,0,0.2),0_3px_8px_rgba(0,0,0,0.15)] hover:bg-white/30 transition-all duration-300 before:absolute before:inset-0  before:bg-gradient-to-br before:from-white/60 before:via-transparent before:to-transparent before:opacity-70 before:pointer-events-none after:absolute after:inset-0 after:bg-gradient-to-tl after:from-white/30 after:via-transparent after:to-transparent after:opacity-50 after:pointer-events-none antialiased" style={{height:'110vh'}}>
