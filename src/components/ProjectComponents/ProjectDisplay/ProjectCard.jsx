...
const ProjectCard = ({data}) => {
  ...
  return (
    <div className='max-w-[269px] hover:scale-105 duration-700 ease-in-out cursor-pointer shrink-0 relative'>
        <div className='relative'>
          {!menu && <div onClick={()=>setMenu(true)} className='absolute right-1.5 top-1.5 p-1 bg-zinc-100 rounded-full hover:scale-115 duration-300 ease-in-out'>
          ...
          {isOwner && 
            <div ref={menuref} className='absolute right-1.5 top-1.5 bg-zinc-100 rounded-lg'>
              <div onClick={()=>{setAllFalse();setPublicBt(true)}} className=' rounded-lg px-1 py-0.5 flex items-center place-content-between text-sm hover:scale-105 hover:bg-blue-100 '>
              ...
              <div onClick={()=>{setAllFalse();setEditBt(true)}} className='px-1 rounded-lg py-0.5 flex place-content-between items-center text-sm hover:scale-105 hover:bg-blue-100 '>
                <p>Rename</p>
              ...
              <div onClick={()=>{setAllFalse();setCopy(true)}} className='px-1 rounded-lg py-0.5 flex  items-center place-content-between text-sm hover:scale-105 hover:bg-blue-100 '>
                <p>Share</p>
              ...
              <div onClick={()=>{setAllFalse();setDeleteBt(true)}} className='px-1 rounded-lg py-0.5 flex items-center place-content-between text-sm hover:scale-105 hover:bg-red-300 text-red-600'>
                <p>Delete</p>
        ...
        {editBt && <div className='w-[95%] bg-zinc-800 text-white rounded-md absolute top-[103px] right-1.5 p-1 cursor-default'>
          <div className='flex justify-around items-center py-3'>
            <p>Rename the project</p>
            <svg onClick={()=>setEditBt(false)} xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"><g fill="none" stroke="#fff" strokeDasharray={16} strokeDashoffset={16} strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}><path d="M7 7l10 10"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.4s" values="16;0"></animate></path><path d="M17 7l-10 10"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.4s" dur="0.4s" values="16;0"></animate></path></g></svg>
          </div>
        ...
        {publicBt && <div className='w-[95%] bg-zinc-800 text-white rounded-md absolute top-[103px] right-1.5 p-1 cursor-default'>
          <div className='flex justify-around items-center py-3'>
            <p>{isPrivate ? "Project is private":"Set it to private"}</p>
            <svg onClick={()=>setPublicBt(false)} xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"><g fill="none" stroke="#fff" strokeDasharray={16} strokeDashoffset={16} strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}><path d="M7 7l10 10"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.4s" values="16;0"></animate></path><path d="M17 7l-10 10"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.4s" dur="0.4s" values="16;0"></animate></path></g></svg>
          </div>
        ...
        {copy && <div className='w-[95%] bg-zinc-800 text-white rounded-md absolute top-[103px] right-1.5 p-1 cursor-default'>
          <div className='flex justify-around items-center py-3'>
            <p>Copy the link</p>
            <svg onClick={()=>setCopy(false)} xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"><g fill="none" stroke="#fff" strokeDasharray={16} strokeDashoffset={16} strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}><path d="M7 7l10 10"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.4s" values="16;0"></animate></path><path d="M17 7l-10 10"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.4s" dur="0.4s" values="16;0"></animate></path></g></svg>
          </div>
        ...
        {deleteBt && <div className='w-[95%] bg-red-300  text-black rounded-md absolute top-[103px] right-1.5 p-1 cursor-default'>
          <div className='flex justify-around items-center py-3'>
            <p className=''>Caution : All the data will be lost</p>
            <svg onClick={()=>setDeleteBt(false)} xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"><g fill="none" stroke="#000" strokeDasharray={16} strokeDashoffset={16} strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}><path d="M7 7l10 10"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.4s" values="16;0"></animate></path><path d="M17 7l-10 10"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.4s" dur="0.4s" values="16;0"></animate></path></g></svg>
          </div>
          <div className='rounded-full  flex p-1 justify-between items-center'>
            ...
            <div onClick={()=>setDeleteBt(false)} className='rounded-full bg-green-500 flex text-white px-1.5 py-0.5 items-center gap-2 cursor-pointer'>
              <p>Cancel</p>
